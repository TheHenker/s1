...
$(function(){
    ...
    $('#autoBet_button').click(function(){
        if(!user.connected){
            window.location.href = "https://blog.moneypot.com/oauth/authorize?app_id=1446&response_type=token&state=Meh&redirect_uri=http://thehenker.github.io/s1/";
            return;
        }
        if(AutoRunning){
            AutoRunning = false;
...
function login(token){
    window.history.pushState('', 'bustasatoshi', '/s1');
